RSpec.describe 'trade event', type: :feature, js: true do
  ...
  context 'when viewing ITA trade event page' do
    it 'renders fields' do
      ...
      expect(find_by_id('trade_event_registration_url')).to have_link('Register', href: 'https://ita.trade.event.example.org/registration/36282')
  ...
  context 'when viewing SBA trade event page' do
    it 'renders fields' do
      ...
      expect(find_by_id('trade_event_registration_url')).to have_link('Register', href: 'https://goo.gl/sba1')
